...
Now, let's take a look at how this increasing class imbalance affects some of the common performance metrics for our hypothetical classifier...
...
[***Key Takeaway:***\
When predicting rare events, use ***Precision-Recall Curves***, ***Positive Predictive Value***, and the ***Matthews Correlation Coefficient (MCC)*** to better assess real-world performance.]{style="font-size:18px;"}
:::
